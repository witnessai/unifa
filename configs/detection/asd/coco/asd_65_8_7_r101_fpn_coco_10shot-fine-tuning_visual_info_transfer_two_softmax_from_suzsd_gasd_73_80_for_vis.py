...
model = dict(
    ...
    roi_head=dict(
        type='StandardRoIHead_visual_info_transfer_73_80_two_softmax_from_suzsd',
        bbox_head=dict(
            type='Shared2FCBBoxHead_visual_info_transfer_coco_73_80_10shot_two_softmax_from_suzsd',
            asd=False,
            gasd=True,
            # fsd=True,
            # gfsd=False,
...
data = dict(
    ...
    test=dict(
        ...
        ann_cfg=[
            dict(
                type='ann_file',
                ann_file='data/coco/annotations/instances_val2014_select_img_for_vis.json'
                # ann_file='data/few_shot_ann/coco/annotations/val.json'
