...
model = dict(
    ...
    roi_head=dict(
        type='StandardRoIHead_visual_info_transfer_two_softmax_from_suzsd_65_80',
        bbox_head=dict(
            type='Shared2FCBBoxHead_visual_info_transfer_coco_65_15_1shot_two_softmax_from_suzsd_65_80',
            fsd=False,
            gfsd=True,
            # fsd=True,
            # gfsd=False,
