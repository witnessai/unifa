...
model = dict(
    ...
    roi_head=dict(
        type='StandardRoIHead_visual_info_transfer_73_7_two_softmax_from_suzsd',
        bbox_head=dict(
            type='Shared2FCBBoxHead_visual_info_transfer_coco_73_7_10shot_two_softmax_from_suzsd',
            # type='ConvFCBBoxHead_visual_info_transfer_coco_73_15_10shot_two_softmax_from_suzsd',
            asd=True,
            gasd=False,
            # fsd=True,
            # gfsd=False,
