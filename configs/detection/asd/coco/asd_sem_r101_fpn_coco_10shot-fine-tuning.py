_base_ = [
    '../../_base_/datasets/any_shot_detection/few_shot_coco.py',
    '../../_base_/schedules/schedule.py', './asd_r101_fpn.py',
...
load_from = ('work_dirs/asd_sem_r101_fpn_coco_base-training/'
