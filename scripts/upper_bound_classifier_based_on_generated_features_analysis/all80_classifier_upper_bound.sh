...
CUDA_VISIBLE_DEVICES=0 python morjio_scripts/train_feature_generator/train_all80_classifier_on_gt_zeroshot_feature.py --manualSeed 42 \
...
--dataroot data/coco/any_shot_detection/base_few_shot_det/multi_labels/base_few_zero_shot \
--testsplit test_0.6_0.3 \
--trainsplit train_0.6_0.3 \
--classes_split 65_8_7 \
--lz_ratio 0.01 \
--outname checkpoints/asd_65_8_7/all80_classifier_upper_bound/train_2nd \
