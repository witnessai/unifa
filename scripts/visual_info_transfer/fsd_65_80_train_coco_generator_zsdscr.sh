...
CUDA_VISIBLE_DEVICES=2 python morjio_scripts/visual_info_transfer/trainer_zsdscr_65_80.py --manualSeed 42 \
...
--lz_ratio 0.01 \
--outname checkpoints/fsd_65_80/both_regressor_triplet \
