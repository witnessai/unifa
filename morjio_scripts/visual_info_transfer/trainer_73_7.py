...
from generate import load_unseen_att, load_all_att, load_zero_shot_att, load_few_zero_shot_att
...
if opt.traincls_classifier == 'zero_shot_set1':
    att_attributes, att_labels = load_zero_shot_att(opt, fs_set=1)  
elif opt.traincls_classifier == 'zero_shot_set2':
    att_attributes, att_labels = load_zero_shot_att(opt, fs_set=2)  
elif opt.traincls_classifier == 'zero_shot_set3':
    att_attributes, att_labels = load_zero_shot_att(opt, fs_set=3)  
