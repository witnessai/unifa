from plot_48_17 import plot_acc, plot_gan_losses, plot_confusion_matrix
from arguments_48_17 import parse_args
import random
import torch
import torch.backends.cudnn as cudnn
import os
import numpy as np
from dataset_48_17 import FeaturesCls, FeaturesGAN
from train_cls_48_17 import TrainCls
from train_gan_48_17 import TrainGAN
from generate_48_17 import load_unseen_att, load_all_att, load_zero_shot_att, load_few_zero_shot_att, load_seen_att_with_bg
from splits_48_17 import get_unseen_class_labels, get_asd_zero_shot_class_labels
import ipdb 
import datetime
...
for epoch in range(start_epoch, opt.nepoch):
    ...
    # ipdb.set_trace()
    # synthesize features
    syn_feature, syn_label = trainFGGAN.generate_syn_feature(att_labels, att_attributes, num=opt.syn_num)
    num_of_bg = opt.syn_num*2
    real_feature_bg, real_label_bg = seenDataset.getBGfeats(num_of_bg)
    # 背景label id重置
    real_label_bg[real_label_bg==48] = 65
    # ipdb.set_trace()
