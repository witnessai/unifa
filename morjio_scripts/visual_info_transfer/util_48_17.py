...
from splits_48_17 import get_unseen_class_labels, get_asd_zero_shot_class_labels, get_asd_few_zero_shot_class_labels, get_asd_base_few_zero_shot_class_labels
...
def compute_per_class_acc(test_label, predicted_label, opt, verbose="Val"):
    ...
    if opt.traincls_classifier == 'zero_shot':
        classes = np.concatenate((get_asd_zero_shot_class_labels(opt.dataset, split=opt.classes_split), ['background']))
