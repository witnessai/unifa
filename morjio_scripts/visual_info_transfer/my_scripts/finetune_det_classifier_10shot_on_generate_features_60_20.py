...
## load text embedding
text_emb_model_path = '/home/nieh/morjio/projects/detection/any_shot_detection/mmfewshot/checkpoints/fsd_60_20/both_regressor_triplet/tfa/10shot/0.3748_best_acc_in_testdata_20230511_text_embedding/gen_best.pth'
...
class Model(nn.Module):
    def __init__(self, tar_size):
        ...
        model_path = '/home/nieh/morjio/projects/detection/any_shot_detection/mmfewshot/work_dirs/tfa_r101_fpn_coco_10shot-fine-tuning_34server/iter_160000.pth'
...
gt_feats = torch.from_numpy(np.load('/home/nieh/morjio/projects/detection/any_shot_detection/mmfewshot/data/coco/any_shot_detection_extracted_feats_and_embedding_classifier/visual_info_transfer/60_20_fsd_split/tfa/10shot/train_0.6_0.3_feats_fine_tuning.npy'))
gt_labels = torch.from_numpy(np.load('/home/nieh/morjio/projects/detection/any_shot_detection/mmfewshot/data/coco/any_shot_detection_extracted_feats_and_embedding_classifier/visual_info_transfer/60_20_fsd_split/tfa/10shot/train_0.6_0.3_labels_fine_tuning.npy'))
gt_feats = gt_feats
gt_labels = gt_labels
...
def validation(model):
    features = torch.from_numpy(np.load('/home/nieh/morjio/projects/detection/any_shot_detection/mmfewshot/data/coco/any_shot_detection_extracted_feats_and_embedding_classifier/visual_info_transfer/60_20_fsd_split/tfa/10shot/test_0.6_0.3_feats.npy')).cuda()
    labels = torch.from_numpy(np.load('/home/nieh/morjio/projects/detection/any_shot_detection/mmfewshot/data/coco/any_shot_detection_extracted_feats_and_embedding_classifier/visual_info_transfer/60_20_fsd_split/tfa/10shot/test_0.6_0.3_labels.npy')).cuda()
    labels[labels==80] = 20
...
for epoch in tqdm(range(epoch_num)):
    ...
    optimizer.step()
    validation(classifier_from_det)
    torch.save({'state_dict': classifier_from_det.state_dict(), 'epoch': epoch}, f"/home/nieh/morjio/projects/detection/any_shot_detection/mmfewshot/work_dirs/tfa_r101_fpn_coco_10shot-fine-tuning_34server/classifier_best_finetuning_on_gen_feats_epoch{epoch}.pth")
ipdb.set_trace()
