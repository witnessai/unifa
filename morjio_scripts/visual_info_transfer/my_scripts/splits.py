...
def get_asd_few_zero_shot_class_labels(dataset, split='65_8_7'):
    if dataset == 'coco':
        return COCO_ASD_FEW_ZERO_SHOT_CLASSES_65_8_7 if '65' in split else COCO_UNSEEN_CLASSES_48_17

def get_asd_few_zero_shot_class_ids(dataset, split='65_8_7'):
    if dataset == 'coco':
        FEW_ZERO_SHOT_CLASSES = COCO_ASD_FEW_ZERO_SHOT_CLASSES_65_8_7 if '65' in split else COCO_UNSEEN_CLASSES_48_17
...
def get_asd_base_few_zero_shot_class_labels(dataset, split='65_8_7'):
    if dataset == 'coco':
        return COCO_ALL_CLASSES if '65' in split else COCO_UNSEEN_CLASSES_48_17

def get_asd_base_few_zero_shot_class_ids(dataset, split='65_8_7'):
    if dataset == 'coco':
        BASE_FEW_ZERO_SHOT_CLASSES = COCO_ALL_CLASSES if '65' in split else COCO_UNSEEN_CLASSES_48_17
