...
## load text embedding
text_emb_model_path = '/home/nieh/morjio/projects/detection/any_shot_detection/mmfewshot/checkpoints/fsd_15_5/both_regressor_triplet/3shot/0.5962_best_acc_in_testdata_20230429_text_embedding/gen_best.pth'
...
class Model(nn.Module):
    def __init__(self, tar_size):
        ...
        model_path = '/home/nieh/morjio/projects/detection/any_shot_detection/mmfewshot/work_dirs/tfa_r101_fpn_voc-split1_3shot-fine-tuning/iter_12000.pth'
...
gt_feats = torch.from_numpy(np.load('/home/nieh/morjio/projects/detection/any_shot_detection/mmfewshot/data/voc/any_shot_detection_extracted_feats_and_embedding_classifier/visual_info_transfer/15_5_fsd_split/tfa/3shot/train_0.6_0.3_feats.npy'))
gt_labels = torch.from_numpy(np.load('/home/nieh/morjio/projects/detection/any_shot_detection/mmfewshot/data/voc/any_shot_detection_extracted_feats_and_embedding_classifier/visual_info_transfer/15_5_fsd_split/tfa/3shot/train_0.6_0.3_labels.npy'))
gt_feats = gt_feats
gt_labels = gt_labels
...
def validation(model):
    features = torch.from_numpy(np.load('/home/nieh/morjio/projects/detection/any_shot_detection/mmfewshot/data/voc/any_shot_detection_extracted_feats_and_embedding_classifier/visual_info_transfer/15_5_fsd_split/tfa/3shot/test_0.6_0.3_feats.npy')).cuda()
    labels = torch.from_numpy(np.load('/home/nieh/morjio/projects/detection/any_shot_detection/mmfewshot/data/voc/any_shot_detection_extracted_feats_and_embedding_classifier/visual_info_transfer/15_5_fsd_split/tfa/3shot/test_0.6_0.3_labels.npy')).cuda()
    labels[labels==20] = 5
...
for epoch in tqdm(range(epoch_num)):
    ...
    optimizer.step()
    validation(classifier_from_det)
    torch.save({'state_dict': classifier_from_det.state_dict(), 'epoch': epoch}, f"/home/nieh/morjio/projects/detection/any_shot_detection/mmfewshot/work_dirs/tfa_r101_fpn_voc-split1_3shot-fine-tuning/classifier_best_finetuning_on_gen_feats_epoch{epoch}.pth")
ipdb.set_trace()

# CUDA_VISIBLE_DEVICES=1 python finetune_det_classifier_3shot_on_generate_features.py