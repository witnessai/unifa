...
for epoch in tqdm(range(epoch_num)):
    ...
    optimizer.step()
    validation(classifier_from_det, test_dataloader)
    torch.save({'state_dict': classifier_from_det.state_dict(), 'epoch': epoch}, f"/home/nieh/morjio/projects/detection/any_shot_detection/mmfewshot/work_dirs/fsd_65_15_r101_fpn_coco_10shot-fine-tuning/classifier_best_finetuning_on_gen_feats_add_base_epoch{epoch}.pth")
ipdb.set_trace()


## shell command
# CUDA_VISIBLE_DEVICES=5 python finetune_det_classifier_on_generate_features_add_base.py
