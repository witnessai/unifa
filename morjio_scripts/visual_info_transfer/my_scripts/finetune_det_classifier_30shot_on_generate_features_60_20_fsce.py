...
## load text embedding
text_emb_model_path = '/home/nieh/morjio/projects/detection/any_shot_detection/mmfewshot/checkpoints/fsd_60_20/both_regressor_triplet/fsce/30shot/0.5191_best_acc_in_testdata_20230512_text_embedding/gen_best.pth'
...
class Model(nn.Module):
    def __init__(self, tar_size):
        ...
        model_path = '/home/nieh/morjio/projects/detection/any_shot_detection/mmfewshot/work_dirs/fsce_r101_fpn_coco_30shot-fine-tuning_34server/iter_40000.pth'
...
gt_feats = torch.from_numpy(np.load('/home/nieh/morjio/projects/detection/any_shot_detection/mmfewshot/data/coco/any_shot_detection_extracted_feats_and_embedding_classifier/visual_info_transfer/60_20_fsd_split/fsce/30shot/train_0.6_0.3_feats_fine_tuning.npy'))
gt_labels = torch.from_numpy(np.load('/home/nieh/morjio/projects/detection/any_shot_detection/mmfewshot/data/coco/any_shot_detection_extracted_feats_and_embedding_classifier/visual_info_transfer/60_20_fsd_split/fsce/30shot/train_0.6_0.3_labels_fine_tuning.npy'))
gt_feats = gt_feats
gt_labels = gt_labels
...
def validation(model):
    features = torch.from_numpy(np.load('/home/nieh/morjio/projects/detection/any_shot_detection/mmfewshot/data/coco/any_shot_detection_extracted_feats_and_embedding_classifier/visual_info_transfer/60_20_fsd_split/fsce/30shot/test_0.6_0.3_feats.npy')).cuda()
    labels = torch.from_numpy(np.load('/home/nieh/morjio/projects/detection/any_shot_detection/mmfewshot/data/coco/any_shot_detection_extracted_feats_and_embedding_classifier/visual_info_transfer/60_20_fsd_split/fsce/30shot/test_0.6_0.3_labels.npy')).cuda()
    labels[labels==80] = 20
...
for epoch in tqdm(range(epoch_num)):
    ...
    optimizer.step()
    validation(classifier_from_det)
    torch.save({'state_dict': classifier_from_det.state_dict(), 'epoch': epoch}, f"/home/nieh/morjio/projects/detection/any_shot_detection/mmfewshot/work_dirs/fsce_r101_fpn_coco_30shot-fine-tuning_34server/classifier_best_finetuning_on_gen_feats_epoch{epoch}.pth")
ipdb.set_trace()

# CUDA_VISIBLE_DEVICES=1 python finetune_det_classifier_30shot_on_generate_features_60_20_fsce.py