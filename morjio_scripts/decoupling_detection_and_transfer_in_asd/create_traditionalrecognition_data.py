...
save_root = '/data1/niehui/decoupling_detection_and_transfer_in_asd/coco_bbox_crop_for_traditionalrecognition/train'
ann_file = '/data1/niehui/MSCOCO/annotations/instances_train2014.json'


# img_root = '/data1/niehui/MSCOCO/val2014'
# save_root = '/data1/niehui/decoupling_detection_and_transfer_in_asd/coco_bbox_crop_for_traditionalrecognition/val'
# ann_file = '/data1/niehui/MSCOCO/annotations/instances_val2014.json'
