...
model_save_path = '/home/nieh/morjio/projects/detection/any_shot_detection/mmfewshot/checkpoints/decoupling_detection_and_transfer_in_asd/fsl_basetrain_v1.pth'
...
# scheduler = torch.optim.lr_scheduler.MultiStepLR(optimizer_resnet, milestones=[25], gamma=0.5)
...
per_epoch_length = len(trainsetloader)
for epoch in range(epoch_max):
    ...
    for i, data in enumerate(trainsetloader, 0):
        ...
        writer.add_scalar('Loss/finetuing', loss.item(), epoch*per_epoch_length+i)
        loss.backward()
    ...
    # scheduler.step()  
    if epoch % 10 == 0:
        gfsl_eval(resnet, epoch)  
print('Finish finetuning!')




model_save_path = '/home/nieh/morjio/projects/detection/any_shot_detection/mmfewshot/checkpoints/decoupling_detection_and_transfer_in_asd/fsl_finetuning_v2.pth'
