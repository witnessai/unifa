...
for epoch in range(epoch_max):
    ...
    for i, data in enumerate(trainsetloader, 0):
        ...
        writer.add_scalar('Loss/basetrain', loss.item(), epoch*per_epoch_length+i)
        loss.backward()
...
model_save_path = '/home/nieh/morjio/projects/detection/any_shot_detection/mmfewshot/checkpoints/decoupling_detection_and_transfer_in_asd/fsl_basetrain.pth'
