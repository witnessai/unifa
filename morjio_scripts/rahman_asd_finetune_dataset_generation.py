...
# ipdb.set_trace()
novel_class_imgid_file_path = f'/home/nieh/morjio/projects/detection/any_shot_detection/mmfewshot/morjio_scripts/novel_class_imgid_of_rahman_asd_{shot_num}shot_finetune_dataset_{seed}.txt'
...
exit(0)
ipdb.set_trace()
save_path = f'/home/nieh/morjio/projects/detection/any_shot_detection/mmfewshot/data/any_shot_ann_65_8_7_split/rahman_asd_full_box_{shot_num}shot_trainval_{seed}.json'
