...
# 第三种小样本类别划分
few_shot_cat_ids = [7, 14, 17, 23, 36, 48, 74, 80] # 65/8 any-shot, 8 few-shot classes
...
ipdb.set_trace()
save_path = f'/home/nieh/morjio/projects/detection/any_shot_detection/mmfewshot/data/any_shot_ann_65_8_7_split/rahman_asd_full_box_{shot_num}shot_trainval_{seed}_v4_for_fs_set3.json'
