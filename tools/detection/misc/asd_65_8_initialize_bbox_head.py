...
## few-shot set 1
COCO_FEW_SHOT_1_CLASSES = [
    7, 14, 23, 36, 48, 58, 80, 89
]

## few-shot set 2
COCO_FEW_SHOT_2_CLASSES = [
    7, 14, 17, 23, 36, 48, 70, 80
]

COCO_FEW_SHOT_3_CLASSES = [
    7, 14, 17, 23, 36, 48, 74, 80
]

COCO_FEW_SHOT_4_CLASSES =  [7, 14, 23, 36, 48, 74, 80, 89]
...
def random_init_checkpoint(param_name, is_weight, tar_size, checkpoint, args):
    ...
    """
    if args.fs_set == 2:
        COCO_NOVEL_CLASSES = COCO_FEW_SHOT_2_CLASSES
        COCO_ALL_CLASSES = sorted(COCO_BASE_CLASSES + COCO_NOVEL_CLASSES)
        COCO_IDMAP = {v: i for i, v in enumerate(COCO_ALL_CLASSES)}
    if args.fs_set == 3:
        COCO_NOVEL_CLASSES = COCO_FEW_SHOT_3_CLASSES
        COCO_ALL_CLASSES = sorted(COCO_BASE_CLASSES + COCO_NOVEL_CLASSES)
        COCO_IDMAP = {v: i for i, v in enumerate(COCO_ALL_CLASSES)}
    if args.fs_set == 4:
        COCO_NOVEL_CLASSES = COCO_FEW_SHOT_4_CLASSES
        COCO_ALL_CLASSES = sorted(COCO_BASE_CLASSES + COCO_NOVEL_CLASSES)
        COCO_IDMAP = {v: i for i, v in enumerate(COCO_ALL_CLASSES)}
