...
class BBoxTestMixin_visual_info_transfer_48_17_two_softmax_from_suzsd: 
    ...
    def simple_test_bboxes(self,
        ...
        if self.bbox_head.gfsd:#rcnn_test_cfg.gfsd:
            cls_score, bbox_pred = self.test_gfsd(rcnn_test_cfg, cls_score, bbox_pred)
...
class MaskTestMixin_visual_info_transfer_48_17_two_softmax_from_suzsd:
