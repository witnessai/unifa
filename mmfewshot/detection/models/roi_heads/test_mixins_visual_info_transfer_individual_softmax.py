...
class BBoxTestMixin_visual_info_transfer_individual_softmax: 
    ...
    def simple_test_bboxes(self,
        ...
        COCO_BASE_CLASSES_AND_BG = list(set(COCO_ALL_CLASSES_AND_BG)-set(COCO_FS_CLASSES))
       
        cls_score[:, COCO_BASE_CLASSES_AND_BG] = F.softmax(cls_score[:, COCO_BASE_CLASSES_AND_BG], dim=1)
        # direct probabilities
        fs_score = F.softmax(fs_score, dim=1)
        # ipdb.set_trace()
        cls_score[:, COCO_FS_CLASSES] = fs_score[:, :-1]
...
class MaskTestMixin_visual_info_transfer_individual_softmax:
