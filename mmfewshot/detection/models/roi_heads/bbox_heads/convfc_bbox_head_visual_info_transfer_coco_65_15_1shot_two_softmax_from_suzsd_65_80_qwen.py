...
class ConvFCBBoxHead_visual_info_transfer_coco_65_15_1shot_two_softmax_from_suzsd_65_80_qwen(BBoxHead_suzsd_get_bbox_without_softmax):
    ...
    def __init__(self,
                 ...
                 *args,
                 **kwargs):
        super(ConvFCBBoxHead_visual_info_transfer_coco_65_15_1shot_two_softmax_from_suzsd_65_80_qwen, self).__init__(
    ...
    def forward(self, x):
        ...
        if self.load_fs_flag is False:
            ...
            model_path = '/home/nieh/morjio/projects/detection/any_shot_detection/mmfewshot/checkpoints/fsd_65_80/both_regressor_triplet_qwen2/2024_09_24_10_19_36/classifier_best_latest.pth'
...
@HEADS.register_module()
class Shared2FCBBoxHead_visual_info_transfer_coco_65_15_1shot_two_softmax_from_suzsd_65_80_qwen(ConvFCBBoxHead_visual_info_transfer_coco_65_15_1shot_two_softmax_from_suzsd_65_80_qwen):

    def __init__(self, fc_out_channels=1024, *args, **kwargs):
        super(Shared2FCBBoxHead_visual_info_transfer_coco_65_15_1shot_two_softmax_from_suzsd_65_80_qwen, self).__init__(
            num_shared_convs=0,
            num_shared_fcs=2,
            num_cls_convs=0,
            num_cls_fcs=0,
...
@HEADS.register_module()
class Shared4Conv1FCBBoxHead_visual_info_transfer_coco_65_15_1shot_two_softmax_from_suzsd_65_80_qwen(ConvFCBBoxHead_visual_info_transfer_coco_65_15_1shot_two_softmax_from_suzsd_65_80_qwen):

    def __init__(self, fc_out_channels=1024, *args, **kwargs):
        super(Shared4Conv1FCBBoxHead_visual_info_transfer_coco_65_15_1shot_two_softmax_from_suzsd_65_80_qwen, self).__init__(
            num_shared_convs=4,
            num_shared_fcs=1,
            num_cls_convs=0,
            num_cls_fcs=0,
