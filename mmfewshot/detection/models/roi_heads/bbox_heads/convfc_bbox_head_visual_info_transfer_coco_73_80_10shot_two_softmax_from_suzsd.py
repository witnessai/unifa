...
class ConvFCBBoxHead_visual_info_transfer_coco_73_80_10shot_two_softmax_from_suzsd(BBoxHead_suzsd_get_bbox_without_softmax):
    ...
    def __init__(self,
                 ...
                 *args,
                 **kwargs):
        super(ConvFCBBoxHead_visual_info_transfer_coco_73_80_10shot_two_softmax_from_suzsd, self).__init__(
    ...
    def forward(self, x):
        ...
        if self.load_fs_flag is False:
            ...
            ## 65/80分类器
            self.model_path = '/home/nieh/morjio/projects/detection/any_shot_detection/mmfewshot/checkpoints/fsd_65_80/0.6818_best_acc_in_testdata_20230419_text_embedding/classifier_best_latest_0.6818.pth'
            ...
            elif 'fsd_65_80' in self.model_path and not self.only_use_zs_classifier:
                pass
            ...
            if 'fsd_65_80' in self.model_path and not self.only_use_zs_classifier:
                COCO_ZERO_SHOT_CLASSES_AND_BG = [4, 28, 29, 48, 52, 61, 78, 80]
...
@HEADS.register_module()
class Shared2FCBBoxHead_visual_info_transfer_coco_73_80_10shot_two_softmax_from_suzsd(ConvFCBBoxHead_visual_info_transfer_coco_73_80_10shot_two_softmax_from_suzsd):

    def __init__(self, fc_out_channels=1024, *args, **kwargs):
        super(Shared2FCBBoxHead_visual_info_transfer_coco_73_80_10shot_two_softmax_from_suzsd, self).__init__(
            num_shared_convs=0,
            num_shared_fcs=2,
            num_cls_convs=0,
            num_cls_fcs=0,
...
@HEADS.register_module()
class Shared4Conv1FCBBoxHead_visual_info_transfer_coco_73_80_10shot_two_softmax_from_suzsd(ConvFCBBoxHead_visual_info_transfer_coco_73_80_10shot_two_softmax_from_suzsd):

    def __init__(self, fc_out_channels=1024, *args, **kwargs):
        super(Shared4Conv1FCBBoxHead_visual_info_transfer_coco_73_80_10shot_two_softmax_from_suzsd, self).__init__(
            num_shared_convs=4,
            num_shared_fcs=1,
            num_cls_convs=0,
            num_cls_fcs=0,
