...
class ConvFCBBoxHead_visual_info_transfer_coco_73_7_10shot_two_softmax_from_suzsd(BBoxHead_suzsd_get_bbox_without_softmax):
    ...
    def __init__(self,
                 ...
                 *args,
                 **kwargs):
        super(ConvFCBBoxHead_visual_info_transfer_coco_73_7_10shot_two_softmax_from_suzsd, self).__init__(
        ...
        self.only_use_zs_classifier = True
    ...
    def forward(self, x):
        ...
        if self.load_fs_flag is False:
            ...
            self.model_path = '/home/nieh/morjio/projects/detection/any_shot_detection/mmfewshot/checkpoints/fsd_73_7/fs_set3/0.7159_best_acc_in_testdata_20230406_text_embedding/classifier_latest.pth' # asd unseen 14.6%
            # self.model_path = '/home/nieh/morjio/projects/detection/any_shot_detection/mmfewshot/checkpoints/fsd_73_7/fs_set3/0.7128_best_acc_in_testdata_20230407_text_embedding/0.9278_classifier_best_bg.pth' # asd unseen 8.9%

            ## 65/15分类器
            self.model_path = '/home/nieh/morjio/projects/detection/any_shot_detection/mmfewshot/checkpoints/fsd_65_15/0.6725_best_acc_in_testdata_20230208_text_embedding/classifier_best_latest.pth'
            # self.model_path = '/home/nieh/morjio/projects/detection/any_shot_detection/mmfewshot/checkpoints/fsd_65_15/both_regressor_triplet/0.6836_best_acc_in_testdata_20230419_text_embedding_addmixup/classifier_best_latest_0.6836.pth'  # asd unseen 16.1%
...
@HEADS.register_module()
class Shared2FCBBoxHead_visual_info_transfer_coco_73_7_10shot_two_softmax_from_suzsd(ConvFCBBoxHead_visual_info_transfer_coco_73_7_10shot_two_softmax_from_suzsd):

    def __init__(self, fc_out_channels=1024, *args, **kwargs):
        super(Shared2FCBBoxHead_visual_info_transfer_coco_73_7_10shot_two_softmax_from_suzsd, self).__init__(
            num_shared_convs=0,
            num_shared_fcs=2,
            num_cls_convs=0,
            num_cls_fcs=0,
...
@HEADS.register_module()
class Shared4Conv1FCBBoxHead_visual_info_transfer_coco_73_7_10shot_two_softmax_from_suzsd(ConvFCBBoxHead_visual_info_transfer_coco_73_7_10shot_two_softmax_from_suzsd):

    def __init__(self, fc_out_channels=1024, *args, **kwargs):
        super(Shared4Conv1FCBBoxHead_visual_info_transfer_coco_73_7_10shot_two_softmax_from_suzsd, self).__init__(
            num_shared_convs=4,
            num_shared_fcs=1,
            num_cls_convs=0,
            num_cls_fcs=0,
