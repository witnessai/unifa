...
class ConvFCBBoxHead2(BBoxHead2):
    ...
    def __init__(self,
                 ...
                 *args,
                 **kwargs):
        super(ConvFCBBoxHead2, self).__init__(
...
@HEADS.register_module()
class Shared2FCBBoxHead2(ConvFCBBoxHead2):
...
@HEADS.register_module()
class Shared4Conv1FCBBoxHead2(ConvFCBBoxHead2):

    def __init__(self, fc_out_channels=1024, *args, **kwargs):
        super(Shared4Conv1FCBBoxHead2, self).__init__(
            num_shared_convs=4,
            num_shared_fcs=1,
            num_cls_convs=0,
            num_cls_fcs=0,
