...
import ipdb 
# from mmfewshot.detection.ops.nms import nms_wrapper
# import sys 
# sys.path.append('/home/niehui/morjio/projects/detection/zero-shot-detection/Synthesizing_the_Unseen_for_Zero-shot_Object_Detection/mmdetection/mmdet')
...
class BBoxHead_visual_info_transfer_attention_generator(BaseModule):
    ...
    def __init__(self,
                 ...
                 init_cfg=None):
        super(BBoxHead_visual_info_transfer_attention_generator, self).__init__(init_cfg)
    ...
    def get_bboxes(self,
        ...
        if self.fs_atten is not None:
            ...
            scores[:, COCO_FS_CLASSES] = scores[:, COCO_FS_CLASSES] * self.fs_atten[:, :len(COCO_FS_CLASSES)] + 1e-7
