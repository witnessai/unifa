...
class ConvFCBBoxHead_with_dpif(BBoxHead2):
    ...
    def __init__(self,
                 ...
                 *args,
                 **kwargs):
        super(ConvFCBBoxHead_with_dpif, self).__init__(
        ...
        unseen_cats = ['person', 'bicycle', 'car', 'motorcycle', 'airplane', 'bus',
                   ...
                   'dining table', 'tv']
        bg_cats = ['__background__'] # the index of bg is 80 rather than 0
...
@HEADS.register_module()
class Shared2FCBBoxHead_with_dpif(ConvFCBBoxHead_with_dpif):

    def __init__(self, fc_out_channels=1024, *args, **kwargs):
        super(Shared2FCBBoxHead_with_dpif, self).__init__(
            num_shared_convs=0,
            num_shared_fcs=2,
            num_cls_convs=0,
            num_cls_fcs=0,
...
@HEADS.register_module()
class Shared4Conv1FCBBoxHead_with_dpif(ConvFCBBoxHead_with_dpif):

    def __init__(self, fc_out_channels=1024, *args, **kwargs):
        super(Shared4Conv1FCBBoxHead_with_dpif, self).__init__(
            num_shared_convs=4,
            num_shared_fcs=1,
            num_cls_convs=0,
            num_cls_fcs=0,
