...
class ConvFCBBoxHead_visual_info_transfer_coco_48_17_0shot_two_softmax_from_suzsd_48_65_qwen(BBoxHead_suzsd_get_bbox_without_softmax):
    ...
    def __init__(self,
                 ...
                 *args,
                 **kwargs):
        super(ConvFCBBoxHead_visual_info_transfer_coco_48_17_0shot_two_softmax_from_suzsd_48_65_qwen, self).__init__(
        ...
        self.additional_all_classifier = nn.Linear(1024, 66).cuda()
    ...
    def forward(self, x):
        ...
        if self.load_fs_flag is False:
            ...
            model_path = '/home/nieh/morjio/projects/detection/any_shot_detection/mmfewshot/checkpoints/fsd_48_17/tfa/0shot/0.5775_best_acc_in_testdata_20230305_text_embedding/classifier_best_latest.pth'

            model_path = '/home/nieh/morjio/projects/detection/any_shot_detection/mmfewshot/checkpoints/fsd_48_17/tfa/0shot/both_regressor_triplet/0.5735_best_acc_in_testdata_20230422_text_embedding/classifier_best_latest.pth'

            model_path = '/home/nieh/morjio/projects/detection/any_shot_detection/mmfewshot/checkpoints/fsd_48_65/tfa/0shot/both_regressor_triplet/0.5663_best_acc_in_testdata_20230424_text_embedding/classifier_best_latest_0.5663.pth'
            model_path = '/home/nieh/morjio/projects/detection/any_shot_detection/mmfewshot/checkpoints/fsd_48_65/tfa/0shot/both_regressor_triplet_qwen2/2024_09_24_10_18_01/classifier_best_latest.pth'
            
            checkpoint = torch.load(model_path)
            COCO_NOVEL_CLASSES_AND_BG = [4, 5, 11, 12, 15, 16, 21, 23, 27, 29, 32, 34, 45, 47, 54, 58, 63, 65]
            ...
            COCO_ALL_CLASSES_AND_BG = list(range(66))
...
@HEADS.register_module()
class Shared2FCBBoxHead_visual_info_transfer_coco_48_17_0shot_two_softmax_from_suzsd_48_65_qwen(ConvFCBBoxHead_visual_info_transfer_coco_48_17_0shot_two_softmax_from_suzsd_48_65_qwen):

    def __init__(self, fc_out_channels=1024, *args, **kwargs):
        super(Shared2FCBBoxHead_visual_info_transfer_coco_48_17_0shot_two_softmax_from_suzsd_48_65_qwen, self).__init__(
            num_shared_convs=0,
            num_shared_fcs=2,
            num_cls_convs=0,
            num_cls_fcs=0,
...
@HEADS.register_module()
class Shared4Conv1FCBBoxHead_visual_info_transfer_coco_48_17_0shot_two_softmax_from_suzsd_48_65_qwen(ConvFCBBoxHead_visual_info_transfer_coco_48_17_0shot_two_softmax_from_suzsd_48_65_qwen):

    def __init__(self, fc_out_channels=1024, *args, **kwargs):
        super(Shared4Conv1FCBBoxHead_visual_info_transfer_coco_48_17_0shot_two_softmax_from_suzsd_48_65_qwen, self).__init__(
            num_shared_convs=4,
            num_shared_fcs=1,
            num_cls_convs=0,
            num_cls_fcs=0,
