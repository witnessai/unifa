...
class CosineSimBBoxHead_visual_info_transfer_coco_65_15_1shot_finetune_det_classifier(ConvFCBBoxHead):
    ...
    def forward(self, x: Tensor) -> Tuple[Tensor, Tensor]:
        ...
        if self.load_fs_flag is False:
            ...
            # ipdb.set_trace()
            model_path = '/home/nieh/morjio/projects/detection/any_shot_detection/mmfewshot/work_dirs/fsd_65_15_fsce_r101_fpn_coco_1shot-fine-tuning/classifier_best_finetuning_on_gen_feats_epoch4.pth'
