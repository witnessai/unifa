...
class ConvFCBBoxHead_visual_info_transfer_coco_65_15_10shot_finetune_det_classifier(BBoxHead2):
    ...
    def __init__(self,
                 ...
                 *args,
                 **kwargs):
        super(ConvFCBBoxHead_visual_info_transfer_coco_65_15_10shot_finetune_det_classifier, self).__init__(
    ...
    def forward(self, x):
        ...
        if self.load_fs_flag is False:
            ...
            model_path = '/home/nieh/morjio/projects/detection/any_shot_detection/mmfewshot/work_dirs/fsd_65_15_r101_fpn_coco_10shot-fine-tuning/classifier_best_finetuning_on_gen_feats_epoch4.pth'
...
@HEADS.register_module()
class Shared2FCBBoxHead_visual_info_transfer_coco_65_15_10shot_finetune_det_classifier(ConvFCBBoxHead_visual_info_transfer_coco_65_15_10shot_finetune_det_classifier):

    def __init__(self, fc_out_channels=1024, *args, **kwargs):
        super(Shared2FCBBoxHead_visual_info_transfer_coco_65_15_10shot_finetune_det_classifier, self).__init__(
            num_shared_convs=0,
            num_shared_fcs=2,
            num_cls_convs=0,
            num_cls_fcs=0,
...
@HEADS.register_module()
class Shared4Conv1FCBBoxHead_visual_info_transfer_coco_65_15_10shot_finetune_det_classifier(ConvFCBBoxHead_visual_info_transfer_coco_65_15_10shot_finetune_det_classifier):

    def __init__(self, fc_out_channels=1024, *args, **kwargs):
        super(Shared4Conv1FCBBoxHead_visual_info_transfer_coco_65_15_10shot_finetune_det_classifier, self).__init__(
            num_shared_convs=4,
            num_shared_fcs=1,
            num_cls_convs=0,
            num_cls_fcs=0,
