...
class CosineSimBBoxHead_visual_info_transfer_coco_60_20_30shot_fsce_finetune_det_classifier(ConvFCBBoxHead):
    ...
    def forward(self, x: Tensor) -> Tuple[Tensor, Tensor]:
        ...
        if self.load_fs_flag is False:
            ...
            # ipdb.set_trace()
            model_path = '/home/nieh/morjio/projects/detection/any_shot_detection/mmfewshot/work_dirs/fsce_r101_fpn_coco_30shot-fine-tuning_34server/classifier_best_finetuning_on_gen_feats_epoch6.pth'
