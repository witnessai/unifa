...
class ContrastiveBBoxHead_visual_info_transfer_voc_15_5_5shot_finetune_det_classifier_fsce_add_cpe(ConvFCBBoxHead):
    ...
    def forward(self, x: Tensor) -> Tuple[Tensor, Tensor, Tensor]:
        ...
        if self.load_fs_flag is False:
            ...
            # ipdb.set_trace()
            model_path = '/home/nieh/morjio/projects/detection/any_shot_detection/mmfewshot/work_dirs/fsce_r101_fpn_contrastive-loss_voc-split1_5shot-fine-tuning/classifier_best_finetuning_on_gen_feats_epoch4.pth'
