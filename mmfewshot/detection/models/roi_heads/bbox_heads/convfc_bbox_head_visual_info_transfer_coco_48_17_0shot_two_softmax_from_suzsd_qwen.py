...
class ConvFCBBoxHead_visual_info_transfer_coco_48_17_0shot_two_softmax_from_suzsd_qwen(BBoxHead_suzsd_get_bbox_without_softmax):
    ...
    def __init__(self,
                 ...
                 *args,
                 **kwargs):
        super(ConvFCBBoxHead_visual_info_transfer_coco_48_17_0shot_two_softmax_from_suzsd_qwen, self).__init__(
    ...
    def forward(self, x):
        ...
        if self.load_fs_flag is False:
            ...
            for idx, c in enumerate(COCO_NOVEL_CLASSES_AND_BG[:-1]):
                ...
                # ipdb.set_trace()
                self.fc_cls.bias[c] = nn.Parameter(torch.tensor(bias[idx]))
            ...
            if use_suzsd_weighted_combine:
                ...
                self.fc_cls.bias[-1] = alpha1*self.fc_cls.bias[-1]+checkpoint['state_dict'][param_name+'.bias'][-1]
            else:
...
@HEADS.register_module()
class Shared2FCBBoxHead_visual_info_transfer_coco_48_17_0shot_two_softmax_from_suzsd_qwen(ConvFCBBoxHead_visual_info_transfer_coco_48_17_0shot_two_softmax_from_suzsd_qwen):

    def __init__(self, fc_out_channels=1024, *args, **kwargs):
        super(Shared2FCBBoxHead_visual_info_transfer_coco_48_17_0shot_two_softmax_from_suzsd_qwen, self).__init__(
            num_shared_convs=0,
            num_shared_fcs=2,
            num_cls_convs=0,
            num_cls_fcs=0,
...
@HEADS.register_module()
class Shared4Conv1FCBBoxHead_visual_info_transfer_coco_48_17_0shot_two_softmax_from_suzsd_qwen(ConvFCBBoxHead_visual_info_transfer_coco_48_17_0shot_two_softmax_from_suzsd_qwen):

    def __init__(self, fc_out_channels=1024, *args, **kwargs):
        super(Shared4Conv1FCBBoxHead_visual_info_transfer_coco_48_17_0shot_two_softmax_from_suzsd_qwen, self).__init__(
            num_shared_convs=4,
            num_shared_fcs=1,
            num_cls_convs=0,
            num_cls_fcs=0,
