...
class ConvFCSemanticBBoxHead(BBoxSemanticHead):
    ...
    def __init__(self,
                 ...
                 *args,
                 **kwargs):
        super(ConvFCSemanticBBoxHead, self).__init__(
        ...
        if self.with_semantic:
            ...
            if self.voc is not None:
                ...
                self.kernel_semantic = nn.Linear(self.num_classes+1, self.num_classes+1)
    ...
    def forward(self, x):
        ...
        if x_semantic.dim() > 2:
            ...
            x_semantic = x_semantic.flatten(1)
...
@HEADS.register_module()
class Shared2FCSemanticBBoxHead(ConvFCSemanticBBoxHead):

    def __init__(self, fc_out_channels=1024, *args, **kwargs):
        super(Shared2FCSemanticBBoxHead, self).__init__(
            num_shared_convs=0,
            num_shared_fcs=2,
            num_semantic_convs=0,
            num_semantic_fcs=0,
...
@HEADS.register_module()
class Shared4Conv1FCSemanticBBoxHead(ConvFCSemanticBBoxHead):

    def __init__(self, fc_out_channels=1024, *args, **kwargs):
        super(Shared4Conv1FCSemanticBBoxHead, self).__init__(
            num_shared_convs=4,
            num_shared_fcs=1,
            num_cls_convs=0,
            num_cls_fcs=0,
