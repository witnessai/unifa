...
class BBoxHead_fsd(BaseModule):
    ...
    def __init__(self,
                 ...
                 init_cfg=None):
        super(BBoxHead_fsd, self).__init__(init_cfg)
    ...
    def loss(self,
        ...
        if cls_score is not None:
            ...
            if type(cls_score) == list:
                asso_prob = cls_score[1]
    ...
    def get_bboxes(self,
        ...
        if self.custom_cls_channels: # False
