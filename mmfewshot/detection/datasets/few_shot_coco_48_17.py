...
COCO_SPLIT = dict(
    OLD_ALL_CLASSES = ('person', 'bicycle', 'car', 'motorcycle', 'truck', 'boat', 'bench', 'bird', 'horse', 'sheep',
    ...
    OLD_BASE_CLASSES = ('person', 'bicycle', 'car', 'motorcycle', 'truck', 'boat', 'bench', 'bird', 'horse', 'sheep',
               'zebra', 'giraffe', 'backpack', 'handbag', 'skis', 'kite', 'surfboard', 'bottle', 'spoon',
               'bowl', 'banana', 'apple', 'orange', 'broccoli', 'carrot', 'pizza', 'donut', 'chair', 'bed',
               'tv', 'laptop', 'remote', 'microwave', 'oven', 'refrigerator', 'book', 'clock', 'vase',
               'toothbrush', 'train', 'bear', 'suitcase', 'frisbee', 'fork', 'sandwich', 'toilet', 'mouse',
               'toaster'), 
    OLD_NOVEL_CLASSES = ('bus', 'dog', 'cow', 'elephant', 'umbrella', 'tie', 'skateboard', 'cup', 'knife', 'cake',
                            'couch', 'keyboard', 'sink', 'scissors', 'airplane', 'cat', 'snowboard'),
...
class FewShotCocoDataset_48_17(BaseFewShotDataset, CocoDataset):
# class FewShotCocoDataset_48_17(BaseFewShotDataset, CocoDataset):
    ...
    Args:
        classes (str | Sequence[str] | None): Classes for model training and
            ...
            it will load pre-defined classes in :obj:`FewShotCocoDataset_48_17`.
    ...
    def __init__(self,
        ...
        assert classes is not None, f'{self.dataset_name}: classes in ' \
                                    f'`FewShotCocoDataset_48_17` can not be None.'
    ...
    def get_classes(self, classes: Union[str, Sequence[str]]) -> List[str]:
        ...
        Args:
            classes (str | Sequence[str]): Classes for model training and
                provide fixed label for each class. When classes is string,
                it will load pre-defined classes in `FewShotCocoDataset_48_17`.
...
@DATASETS.register_module()
class AnyShotCocoCopyDataset_48_17(FewShotCocoDataset_48_17):
    ...
    Args:
        ann_cfg (list[dict] | dict): contain `data_infos` from other
            dataset. Example: [dict(data_infos=FewShotCocoDataset_48_17.data_infos)]
    """
    ...
    def ann_cfg_parser(self, ann_cfg: Union[List[Dict], Dict]) -> List[Dict]:
        ...
        Args:
            ann_cfg (list[dict] | dict): contain `data_infos` from other
                dataset. Example:
                [dict(data_infos=FewShotCocoDataset_48_17.data_infos)]
...
@DATASETS.register_module()
class FewShotCocoDefaultDataset_48_17(FewShotCocoDataset_48_17):
    """AnyShot COCO Dataset with some pre-defined annotation paths.

    :obj:`FewShotCocoDefaultDataset_48_17` provides pre-defined annotation files
    ...
    different from :obj:`FewShotCocoDataset_48_17`. The `ann_cfg' should contain
    ...
    def ann_cfg_parser(self, ann_cfg: List[Dict]) -> List[Dict]:
        ...
        return super(FewShotCocoDataset_48_17, self).ann_cfg_parser(new_ann_cfg)
