...
@DATASETS.register_module()
class AnyShotCocoCopyDataset(FewShotCocoDataset_65_15):
...
@DATASETS.register_module()
class FewShotCocoDefaultDataset_65_15(FewShotCocoDataset_65_15):
    ...
    def ann_cfg_parser(self, ann_cfg: List[Dict]) -> List[Dict]:
        ...
        return super(FewShotCocoDataset_65_15, self).ann_cfg_parser(new_ann_cfg)
