...
COCO_SPLIT = dict(
    ...
    NOVEL_CLASSES=('airplane', 'train', 'parking meter', 'cat', 'bear', 'suitcase', 
                 'frisbee', 'snowboard', 'fork', 'sandwich', 'hot dog', 'toilet', 
                 'mouse', 'toaster', 'hair drier'),
    ...
    ALL_CLASSES_for_set_1=(
        # 65+8 original order
        'person', 'bicycle', 'car', 'motorcycle',  'bus',
                 'train', 'truck', 'boat', 'traffic light', 'fire hydrant',
                 'stop sign', 'parking meter', 'bench', 'bird',  'dog',
                 'horse', 'sheep', 'cow', 'elephant', 'bear', 'zebra',
                 'giraffe', 'backpack', 'umbrella', 'handbag', 'tie',
    ...
    FEW_SHOT_CLASSES_2=('train', 'parking meter', 'cat', 'bear', 'snowboard', 'fork', 'toilet', 'toaster'),
    ZERO_SHOT_CLASSES_2=('airplane',  'suitcase', 'frisbee', 'sandwich', 'hot dog', 'mouse', 'hair drier'),

    FEW_SHOT_CLASSES_3=('train', 'parking meter', 'cat', 'bear', 'snowboard', 'fork', 'mouse', 'toaster'),
    ZERO_SHOT_CLASSES_3=('airplane',  'suitcase', 'frisbee', 'sandwich', 'hot dog', 'toilet', 'hair drier'),

    FEW_SHOT_CLASSES_4=('train', 'parking meter', 'bear', 'snowboard', 'fork',  'mouse', 'toaster', 'hair drier'), 
    ZERO_SHOT_CLASSES_4=('airplane',  'cat', 'suitcase', 'frisbee',  'sandwich', 'hot dog', 'toilet'),

    BASE_FEW_SHOT_1_CLASSES=('person', 'bicycle', 'car', 'motorcycle',  'bus',
                 'train', 'truck', 'boat', 'traffic light', 'fire hydrant',
                 'stop sign', 'parking meter', 'bench', 'bird',  'dog',
                 'horse', 'sheep', 'cow', 'elephant', 'bear', 'zebra',
                 'giraffe', 'backpack', 'umbrella', 'handbag', 'tie',
                 ...
                 'toaster', 'sink', 'refrigerator', 'book', 'clock', 'vase',
                 'scissors', 'teddy bear', 'hair drier', 'toothbrush', ),
    BASE_FEW_SHOT_2_CLASSES=('person', 'bicycle', 'car', 'motorcycle', 'bus',
                 'train', 'truck', 'boat', 'traffic light', 'fire hydrant',
                 'stop sign', 'parking meter', 'bench', 'bird', 'cat', 'dog',
                 'horse', 'sheep', 'cow', 'elephant', 'bear', 'zebra',
                 'giraffe', 'backpack', 'umbrella', 'handbag', 'tie',
                 ...
                 'toaster', 'sink', 'refrigerator', 'book', 'clock', 'vase',
                 'scissors', 'teddy bear',  'toothbrush'),
     BASE_FEW_SHOT_3_CLASSES=('person', 'bicycle', 'car', 'motorcycle',  'bus',
                 'train', 'truck', 'boat', 'traffic light', 'fire hydrant',
                 'stop sign', 'parking meter', 'bench', 'bird', 'cat', 'dog',
                 'horse', 'sheep', 'cow', 'elephant', 'bear', 'zebra',
                 'giraffe', 'backpack', 'umbrella', 'handbag', 'tie',
                 ...
                 'fork', 'knife', 'spoon', 'bowl', 'banana', 'apple',
                  'orange', 'broccoli', 'carrot', 
                 'pizza', 'donut', 'cake', 'chair', 'couch', 'potted plant',
                 'bed', 'dining table',  'tv', 'laptop', 'mouse', 
                 'remote', 'keyboard', 'cell phone', 'microwave', 'oven',
                 'toaster', 'sink', 'refrigerator', 'book', 'clock', 'vase',
                 'scissors', 'teddy bear',  'toothbrush'),
    BASE_FEW_SHOT_4_CLASSES=('person', 'bicycle', 'car', 'motorcycle', 'bus',
                 'train', 'truck', 'boat', 'traffic light', 'fire hydrant',
                 'stop sign', 'parking meter', 'bench', 'bird', 'dog',
                 'horse', 'sheep', 'cow', 'elephant', 'bear', 'zebra',
                 'giraffe', 'backpack', 'umbrella', 'handbag', 'tie',
...
class AnyShotCocoDataset_65_8_7(BaseFewShotDataset, CocoDataset):
# class AnyShotCocoDataset_65_8_7(BaseFewShotDataset, CocoDataset):
    ...
    def __init__(self,
        ...
        assert classes is not None, f'{self.dataset_name}: classes in ' \
                                    f'`AnyShotCocoDataset_65_8_7` can not be None.'
...
@DATASETS.register_module()
class AnyShotCocoCopyDataset_65_8_7(AnyShotCocoDataset_65_8_7):
    ...
    def ann_cfg_parser(self, ann_cfg: Union[List[Dict], Dict]) -> List[Dict]:
        ...
        if isinstance(ann_cfg, dict):
            assert ann_cfg.get('data_infos', None) is not None, \
                'ann_cfg of AnyShotCocoCopyDataset require data_infos.'
...
@DATASETS.register_module()
class AnyShotCocoDefaultDataset_65_8_7(AnyShotCocoDataset_65_8_7):
    """AnyShot COCO Dataset with some pre-defined annotation paths.
    ...
    DEFAULT_ANN_CONFIG = dict(
        ...
        Attention_RPN={
            **coco_benchmark, 'Official_10SHOT': [
                dict(
                    type='ann_file',
                    ann_file='data/any_shot_ann/coco/attention_rpn_10shot/'
    ...
    def ann_cfg_parser(self, ann_cfg: List[Dict]) -> List[Dict]:
        ...
        return super(AnyShotCocoDataset_65_8_7, self).ann_cfg_parser(new_ann_cfg)
