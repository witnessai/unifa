_base_ = [
    ...
    '../../_base_/schedules/schedule.py', './tfa_r101_fpn_with_unit_transfer.py',
...
model = dict(roi_head=dict(
        type='StandardRoIHead_fsd',
        bbox_head=dict(
            type='Shared2FCBBoxHead_with_dpif_add_asso_loss',
            loss_cls=dict(
                type='CrossEntropyLoss_with_asso_prob', use_sigmoid=False, loss_weight=1.0),
            num_classes=80)
        ))
