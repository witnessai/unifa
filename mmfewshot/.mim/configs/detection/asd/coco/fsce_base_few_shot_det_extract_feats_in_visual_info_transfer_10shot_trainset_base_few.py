...
load_from = ('work_dirs/fsd_65_15_fsce_r101_fpn_coco_10shot-fine-tuning/'
             'iter_30000.pth')
...
data = dict(
    ...
    train=dict(
        ...
        ann_cfg=[
            dict(
                type='ann_file',
                ann_file='data/coco/annotations/combine_base_few_shot_json_in_visual_info_transfer/base_few_shot_json_for_extract_feats_in_visual_info_transfer_10shot.json'
