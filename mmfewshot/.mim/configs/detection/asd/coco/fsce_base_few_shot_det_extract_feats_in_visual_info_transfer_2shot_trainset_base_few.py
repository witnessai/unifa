...
data = dict(
    ...
    train=dict(
        ...
        ann_cfg=[
            dict(
                type='ann_file',
                ann_file='data/coco/annotations/combine_base_few_shot_json_in_visual_info_transfer/base_few_shot_json_for_extract_feats_in_visual_info_transfer_2shot.json'
