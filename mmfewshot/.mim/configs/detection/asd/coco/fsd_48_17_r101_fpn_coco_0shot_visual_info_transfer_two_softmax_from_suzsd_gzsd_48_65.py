...
model = dict(
    ...
    roi_head=dict(
        type='StandardRoIHead_visual_info_transfer_48_17_two_softmax_from_suzsd_48_65',
        bbox_head=dict(
            type='Shared2FCBBoxHead_visual_info_transfer_coco_48_17_0shot_two_softmax_from_suzsd_48_65',
            # fsd=True,
            # gfsd=False,
            fsd=False,
            gfsd=True,
