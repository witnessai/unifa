...
model = dict(
    roi_head=dict(
        bbox_head=dict(
            type='CosineSimBBoxHead_visual_info_transfer_coco_65_15_2shot_finetune_det_classifier'
            )),
)
...
data = dict(
    ...
    train=dict(
        ...
        ann_cfg=[
            dict(
                type='ann_file',
                ann_file='data/few_shot_ann_65_15_split/rahman_fsd_full_box_2shot_trainval.json'
