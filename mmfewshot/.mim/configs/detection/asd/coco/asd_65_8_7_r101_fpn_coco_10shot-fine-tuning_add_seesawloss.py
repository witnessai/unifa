...
lr_config = dict(policy='step', warmup_iters=10, step=[30000])
...
model = dict(
    ...
    roi_head=dict(
        bbox_head=dict(
            num_classes=73, 
            loss_cls=dict(
                type='SeesawLoss_for_asd', use_sigmoid=False, loss_weight=1.0),)))
    ...
    train=dict(
        ...
        ann_cfg=[
            dict(
                ...
                ann_file='data/any_shot_ann_65_8_7_split/rahman_asd_full_box_10shot_trainval_42_v4.json'
                )
        ],
