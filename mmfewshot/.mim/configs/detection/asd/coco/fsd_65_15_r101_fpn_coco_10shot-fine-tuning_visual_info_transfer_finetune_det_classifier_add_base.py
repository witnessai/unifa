...
model = dict(
    roi_head=dict(
        type='StandardRoIHead_visual_info_transfer_finetune_det_classifier_add_base',
        bbox_head=dict(
            type='Shared2FCBBoxHead_visual_info_transfer_finetune_det_classifier_add_base',
            )
    )
)
