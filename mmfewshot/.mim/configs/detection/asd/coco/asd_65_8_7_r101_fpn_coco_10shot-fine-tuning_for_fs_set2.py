...
load_from = ('work_dirs/asd_65_8_7_r101_fpn_coco_base-training/'
             'base_model_random_init_bbox_head_for_fs_set2.pth')
    ...
    train=dict(
        ...
        ann_cfg=[
            dict(
                ...
                ann_file='data/any_shot_ann_65_8_7_split/rahman_asd_full_box_10shot_trainval_42_v4_for_fs_set2.json'
                )
        ],
        ...
        classes='BASE_FEW_SHOT_2_CLASSES',
        instance_wise=False),
    val=dict(
        type='AnyShotCocoDataset_65_8_7',
        ann_cfg=[
...
evaluation = dict(
    ...
    class_splits=['BASE_CLASSES', 'FEW_SHOT_CLASSES_2', 'ZERO_SHOT_CLASSES_2']
    )
